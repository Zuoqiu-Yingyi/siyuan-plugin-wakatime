...
var xs = (e, t, r) => t in e ? Es(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r;
var Qe = (e, t, r) => (xs(e, typeof t != "symbol" ? t + "" : t, r), r);
var Ps = Object.defineProperty, Rs = (e, t, r) => t in e ? Ps(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, pe = (e, t, r) => (Rs(e, typeof t != "symbol" ? t + "" : t, r), r);
function tn(e, t) {
  return function() {
...
})(/* @__PURE__ */ Object.create(null)), X = (e) => (e = e.toLowerCase(), (t) => yt(t) === e), gt = (e) => (t) => typeof t === e, { isArray: Ne } = Array, We = gt("undefined");
function As(e) {
  return e !== null && !We(e) && e.constructor !== null && !We(e.constructor) && H(e.constructor.isBuffer) && e.constructor.isBuffer(e);
}
const rn = X("ArrayBuffer");
function Ys(e) {
  let t;
  return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? t = ArrayBuffer.isView(e) : t = e && e.buffer && rn(e.buffer), t;
}
const Cs = gt("string"), H = gt("function"), nn = gt("number"), wt = (e) => e !== null && typeof e == "object", Fs = (e) => e === !0 || e === !1, rt = (e) => {
  if (yt(e) !== "object")
    return !1;
  const t = or(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, Ls = X("Date"), Is = X("File"), Us = X("Blob"), Bs = X("FileList"), Ws = (e) => wt(e) && H(e.pipe), js = (e) => {
  let t;
...
}, Hs = X("URLSearchParams"), qs = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const an = (() => typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global)(), on = (e) => !We(e) && e !== an;
function Gt() {
...
const Vs = (e, t, r, { allOwnKeys: n } = {}) => (Ge(t, (s, a) => {
  ...
  for (; (r = e.exec(t)) !== null; )
    n.push(r);
  return n;
}, ea = X("HTMLFormElement"), ta = (e) => e.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(t, r, n) {
    return r.toUpperCase() + n;
  }
), Nr = (({ hasOwnProperty: e }) => (t, r) => e.call(t, r))(Object.prototype), ra = X("RegExp"), ln = (e, t) => {
...
const ua = (e) => {
  ...
  return r(e, 0);
}, ca = X("AsyncFunction"), ha = (e) => e && (wt(e) || H(e)) && H(e.then) && H(e.catch), c = {
  isArray: Ne,
  isArrayBuffer: rn,
  isBuffer: As,
  isFormData: js,
...
function _t(e, t, r) {
  ...
  function d(y, P, re) {
    ...
    if (y && !re && typeof y == "object") {
      ...
      else if (c.isArray(y) && fa(y) || (c.isFileList(y) || c.endsWith(P, "[]")) && (de = c.toArray(y)))
        return P = dn(P), de.forEach(function(Ct, Ms) {
          !(c.isUndefined(Ct) || Ct === null) && t.append(
            // eslint-disable-next-line no-nested-ternary
            i === !0 ? Yr([P], Ms, a) : i === null ? P : P + "[]",
            o(Ct)
          );
        }), !1;
    }
    return $t(y) ? !0 : (t.append(Yr(re, P, a), o(y)), !1);
  }
  const f = [], _ = Object.assign(pa, {
    defaultVisitor: d,
    convertValue: o,
    isVisitable: $t
  });
  function k(y, P) {
    if (!c.isUndefined(y)) {
      ...
      f.push(y), c.forEach(y, function(re, de) {
        (!(c.isUndefined(re) || re === null) && s.call(
          t,
          re,
          c.isString(de) ? de.trim() : de,
          P,
          _
        )) === !0 && k(re, P ? P.concat(de) : [de]);
      }), f.pop();
    }
  }
  if (!c.isObject(e))
...
}, ga = typeof URLSearchParams < "u" ? URLSearchParams : lr, wa = typeof FormData < "u" ? FormData : null, _a = typeof Blob < "u" ? Blob : null, ba = (() => {
  let e;
...
function Sa(e, t) {
  return _t(e, new Z.classes.URLSearchParams(), Object.assign({
...
let kt = class {
  ...
  set(e, t, r) {
    ...
    return c.isPlainObject(e) || e instanceof this.constructor ? a(e, t) : c.isString(e) && (e = e.trim()) && !Pa(e) ? a(Ea(e), t) : e != null && s(t, e, r), this;
  }
  get(e, t) {
    if (e = Ce(e), e) {
...
const oe = kt;
function It(e, t) {
  const r = this || ur, n = t || r, s = oe.from(n.headers);
  let a = n.data;
...
const Ba = typeof XMLHttpRequest < "u", Wa = Ba && function(e) {
  return new Promise(function(t, r) {
    let n = e.data;
    const s = oe.from(e.headers).normalize(), a = e.responseType;
    let i;
    function u() {
...
function Ur(e) {
  return Ut(e), e.headers = oe.from(e.headers), e.data = It.call(
    e,
    e.transformRequest
    ...
    return Ut(e), t.data = It.call(
      ...
      e.transformResponse,
      t
    ), t.headers = oe.from(t.headers), t;
  }, function(t) {
    return gn(t) || (Ut(e), t && t.response && (t.response.data = It.call(
      e,
      e.transformResponse,
      t.response
    ), t.response.headers = oe.from(t.response.headers))), Promise.reject(t);
  });
}
const Br = (e) => e instanceof oe ? e.toJSON() : e;
function Re(e, t) {
  t = t || {};
  const r = {};
  function n(d, f, _) {
    return c.isPlainObject(d) && c.isPlainObject(f) ? c.merge.call({ caseless: _ }, d, f) : c.isPlainObject(f) ? c.merge({}, f) : c.isArray(f) ? f.slice() : f;
  }
  function s(d, f, _) {
    if (c.isUndefined(f)) {
      if (!c.isUndefined(d))
  ...
  const o = {
    ...
    responseEncoding: i,
    validateStatus: u,
    headers: (d, f) => s(Br(d), Br(f), !0)
  };
  return c.forEach(Object.keys(Object.assign({}, e, t)), function(d) {
    const f = o[d] || s, _ = f(e[d], t[d], d);
    c.isUndefined(_) && f !== u || (r[d] = _);
  }), r;
}
const _n = "1.4.0", cr = {};
...
cr.transitional = function(e, t, r) {
  function n(s, a) {
    return "[Axios v" + _n + "] Transitional option '" + s + "'" + a + (r ? ". " + r : "");
  }
  return (s, a, i) => {
    if (e === !1)
      throw new O(
    ...
    return t && !Wr[a] && (Wr[a] = !0, console.warn(
      n(
        a,
...
let ut = class {
  ...
  request(e, t) {
    ...
    if (!u) {
      ...
      for (y.unshift.apply(y, i), y.push.apply(y, o), _ = y.length, d = Promise.resolve(t); f < _; )
        d = d.then(y[f++], y[f++]);
      return d;
    }
    _ = i.length;
    ...
    for (f = 0, _ = o.length; f < _; )
      d = d.then(o[f++], o[f++]);
    return d;
  }
  getUri(e) {
    e = Re(this.defaults, e);
    const t = wn(e.baseURL, e.url);
...
const Sn = Y, {
  ...
  formToJSON: Ph,
  mergeConfig: Rh
} = Sn, Ka = /"(?:_|\\u0{2}5[Ff]){2}(?:p|\\u0{2}70)(?:r|\\u0{2}72)(?:o|\\u0{2}6[Ff])(?:t|\\u0{2}74)(?:o|\\u0{2}6[Ff])(?:_|\\u0{2}5[Ff]){2}"\s*:/, Za = /"(?:c|\\u0063)(?:o|\\u006[Ff])(?:n|\\u006[Ee])(?:s|\\u0073)(?:t|\\u0074)(?:r|\\u0072)(?:u|\\u0075)(?:c|\\u0063)(?:t|\\u0074)(?:o|\\u006[Ff])(?:r|\\u0072)"\s*:/, Qa = /^\s*["[{]|^\s*-?\d[\d.]{0,14}\s*$/;
function Xa(e, t) {
...
function fi(e, t) {
  return (typeof t == "number" || typeof t == "boolean") && (t = String(t)), t ? Array.isArray(t) ? t.map((r) => `${Bt(e)}=${Kt(r)}`).join("&") : `${Bt(e)}=${Kt(t)}` : Bt(e);
}
function pi(e) {
...
function Tn(e) {
  ...
  const s = async function(i, u = {}) {
    ...
    o.options.onRequest && await o.options.onRequest(o), typeof o.request == "string" && (o.options.baseURL && (o.request = ki(o.request, o.options.baseURL)), (o.options.query || o.options.params) && (o.request = Si(o.request, {
      ...o.options.params,
      ...o.options.query
    })), o.options.body && Hr(o.options.method) && Ri(o.options.body) && (o.options.body = typeof o.options.body == "string" ? o.options.body : JSON.stringify(o.options.body), o.options.headers = new r(o.options.headers || {}), o.options.headers.has("content-type") || o.options.headers.set("content-type", "application/json"), o.options.headers.has("accept") || o.options.headers.set("accept", "application/json")));
    try {
      o.response = await t(
        o.request,
        o.options
    ...
    if (d === "json") {
      const f = await o.response.text(), _ = o.options.parseResponse || ti;
      o.response._data = _(f);
    } else
...
}(), Li = Mn.fetch || (() => Promise.reject(new Error("[ofetch] global.fetch is not supported!"))), Ii = Mn.Headers, Ui = Tn({ fetch: Li, Headers: Ii }), Wt = {
...
class Bi extends Error {
  constructor(t) {
    super(t.statusText), pe(this, "status"), this.response = t, this.status = t.status;
  }
}
class Qt extends Error {
  constructor(t, r) {
    super(t.msg), pe(this, "code"), this.body = t, this.response = r, this.code = t.code;
  }
}
var qr, Vr, Gr, $r, zr;
const En = class l {
  constructor(t = {}, r = "xhr") {
    pe(this, "_type", "xhr"), pe(this, "_baseURL", ((Vr = (qr = globalThis.top) == null ? void 0 : qr.document) == null ? void 0 : Vr.baseURI) ?? (($r = (Gr = globalThis.parent) == null ? void 0 : Gr.document) == null ? void 0 : $r.baseURI) ?? ((zr = globalThis.location) == null ? void 0 : zr.origin) ?? Wt.SIYUAN_DEFAULT_BASE_URL), pe(this, "_token", Wt.SIYUAN_DEFAULT_TOKEN), pe(this, "_axios", Sn.create({
      baseURL: this._baseURL,
      timeout: Wt.REQUEST_TIMEOUT,
      headers: {
        Authorization: `Token ${this._token}`
      }
    })), pe(this, "_fetch", Ui.create({
      baseURL: this._baseURL,
      headers: {
        Authorization: `Token ${this._token}`
      }
...
class ji {
  constructor(t, r, n = n) {
    this.handlers = t, this.logger = r, this.self = n, this.errerEventListener = async (s) => {
      this.logger.warn(s);
    }, this.messageEventListener = async (s) => {
      const a = s.data;
      switch (a.type) {
        case "call": {
          const u = await this.handlers[a.handler.name].call(this.self, ...a.handler.args), o = {
            type: "call",
            id: a.id,
            handler: {
              name: a.handler.name,
          ...
          this.self.postMessage(o);
          break;
        }
      }
    }, this.self.addEventListener("error", this.errerEventListener), this.self.addEventListener("messageerror", this.errerEventListener), this.self.addEventListener("message", this.messageEventListener);
  }
  close() {
...
var Xt = /* @__PURE__ */ ((e) => (e.Coding = "coding", e.Building = "building", e.Indexing = "indexing", e.Debugging = "debugging", e.Browsing = "browsing", e.RunningTests = "running tests", e.WritingTests = "writing tests", e.ManualTesting = "manual testing", e.WritingDocs = "writing docs", e.CodeReviewing = "code reviewing", e.Researching = "researching", e.Learning = "learning", e.Designing = "designing", e))(Xt || {}), xn = /* @__PURE__ */ ((e) => (e.App = "app", e.File = "file", e.Domain = "domain", e))(xn || {});
const Vi = {
  wakatime: {
    api_url: "",
    api_key: "",
...
function fr(e) {
  if (e._isValid == null) {
    var t = w(e), r = er.call(t.parsedDateParts, function(s) {
      return s != null;
...
function St(e) {
  var t = ee(NaN);
  return e != null ? me(w(t), e) : w(t).userInvalidated = !0, t;
}
var Jr = p.momentProperties = [], jt = !1;
function pr(e, t) {
  var r, n, s, a = Jr.length;
  if (U(t._isAMomentObject) || (e._isAMomentObject = t._isAMomentObject), U(t._i) || (e._i = t._i), U(t._f) || (e._f = t._f), U(t._l) || (e._l = t._l), U(t._strict) || (e._strict = t._strict), U(t._tzm) || (e._tzm = t._tzm), U(t._isUTC) || (e._isUTC = t._isUTC), U(t._offset) || (e._offset = t._offset), U(t._pf) || (e._pf = w(t)), U(t._locale) || (e._locale = t._locale), a > 0)
    for (r = 0; r < a; r++)
      n = Jr[r], s = t[n], U(s) || (e[n] = s);
  return e;
}
function Je(e) {
...
var Kr = {};
function An(e, t) {
  p.deprecationHandler != null && p.deprecationHandler(e, t), Kr[e] || (Nn(t), Kr[e] = !0);
}
...
function tr(e, t) {
  var r = me({}, e), n;
  for (n in t)
    v(t, n) && (ke(e[n]) && ke(t[n]) ? (r[n] = {}, me(r[n], e[n]), me(r[n], t[n])) : t[n] != null ? r[n] = t[n] : delete r[n]);
  for (n in e)
    v(e, n) && !v(t, n) && ke(e[n]) && (r[n] = me({}, r[n]));
  return r;
}
function mr(e) {
  e != null && this.set(e);
...
function it(e, t) {
  return e.isValid() ? (t = Yn(t, e.localeData()), Ht[t] = Ht[t] || Qi(t), Ht[t](e)) : e.localeData().invalidDate();
}
function Yn(e, t) {
  var r = 5;
  function n(s) {
...
var Ln = /\d/, W = /\d\d/, In = /\d{3}/, wr = /\d{4}/, vt = /[+-]?\d{6}/, x = /\d\d?/, Un = /\d\d\d\d?/, Bn = /\d\d\d\d\d\d?/, Dt = /\d{1,3}/, _r = /\d{1,4}/, Tt = /[+-]?\d{1,6}/, Ye = /\d+/, Mt = /[+-]?\d+/, fo = /Z|[+-]\d\d:?\d\d/gi, Et = /Z|[+-]\d\d(?::?\d\d)?/gi, po = /[+-]?\d+(\.\d{1,3})?/, Ke = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, ht;
ht = {};
function m(e, t, r) {
  ht[e] = te(t) ? t : function(n, s) {
    return n && r ? r : t;
  };
}
function mo(e, t) {
  return v(ht, e) ? ht[e](t._strict, t._locale) : new RegExp(yo(e));
}
function yo(e) {
  return B(
    e.replace("\\", "").replace(
...
function M(e, t) {
  var r, n = t, s;
  for (typeof e == "string" && (e = [e]), ue(t) && (n = function(a, i) {
    i[t] = b(a);
...
var C = 0, ae = 1, K = 2, A = 3, G = 4, ie = 5, be = 6, wo = 7, _o = 8;
function bo(e, t) {
  return (e % t + t) % t;
}
var N;
...
M(["MMM", "MMMM"], function(e, t, r, n) {
  ...
  s != null ? t[ae] = s : w(r).invalidMonth = e;
});
var ko = "January_February_March_April_May_June_July_August_September_October_November_December".split(
  "_"
), Wn = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), jn = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, So = Ke, Oo = Ke;
function vo(e, t) {
...
function xo(e) {
  return this._monthsParseExact ? (v(this, "_monthsRegex") || Vn.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (v(this, "_monthsShortRegex") || (this._monthsShortRegex = So), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex);
}
function Po(e) {
  return this._monthsParseExact ? (v(this, "_monthsRegex") || Vn.call(this), e ? this._monthsStrictRegex : this._monthsRegex) : (v(this, "_monthsRegex") || (this._monthsRegex = Oo), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex);
}
function Vn() {
  function e(i, u) {
  ...
  var t = [], r = [], n = [], s, a;
  for (s = 0; s < 12; s++)
    a = ee([2e3, s]), t.push(this.monthsShort(a, "")), r.push(this.months(a, "")), n.push(this.months(a, "")), n.push(this.monthsShort(a, ""));
...
function He(e, t, r) {
  ...
  return s < 1 ? (i = e.year() - 1, a = s + le(i, t, r)) : s > le(e.year(), t, r) ? (a = s - le(e.year(), t, r), i = e.year() + 1) : (i = e.year(), a = s), {
    week: a,
    year: i
  };
}
...
var Wo = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), zn = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), jo = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), Ho = Ke, qo = Ke, Vo = Ke;
function Go(e, t) {
...
function Zo(e) {
  ...
  return e != null ? (e = Uo(e, this.localeData()), this.add(e - t, "d")) : t;
}
function Qo(e) {
  if (!this.isValid())
    return e != null ? this : NaN;
...
function el(e) {
  return this._weekdaysParseExact ? (v(this, "_weekdaysRegex") || kr.call(this), e ? this._weekdaysStrictRegex : this._weekdaysRegex) : (v(this, "_weekdaysRegex") || (this._weekdaysRegex = Ho), this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex);
}
function tl(e) {
  return this._weekdaysParseExact ? (v(this, "_weekdaysRegex") || kr.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (v(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = qo), this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
}
function rl(e) {
  return this._weekdaysParseExact ? (v(this, "_weekdaysRegex") || kr.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (v(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Vo), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
}
function kr() {
  function e(f, _) {
  ...
  for (a = 0; a < 7; a++)
    i = ee([2e3, 1]).day(a), u = B(this.weekdaysMin(i, "")), o = B(this.weekdaysShort(i, "")), d = B(this.weekdays(i, "")), t.push(u), r.push(o), n.push(d), s.push(u), s.push(o), s.push(d);
...
g("k", ["kk", 2], 0, nl);
g("hmm", 0, 0, function() {
  return "" + Sr.apply(this) + Q(this.minutes(), 2);
});
g("hmmss", 0, 0, function() {
  return "" + Sr.apply(this) + Q(this.minutes(), 2) + Q(this.seconds(), 2);
});
g("Hmm", 0, 0, function() {
...
M(["h", "hh"], function(e, t, r) {
  t[A] = b(e), w(r).bigHour = !0;
});
M("hmm", function(e, t, r) {
  var n = e.length - 2;
  t[A] = b(e.substr(0, n)), t[G] = b(e.substr(n)), w(r).bigHour = !0;
});
M("hmmss", function(e, t, r) {
  var n = e.length - 4, s = e.length - 2;
  t[A] = b(e.substr(0, n)), t[G] = b(e.substr(n, 2)), t[ie] = b(e.substr(s)), w(r).bigHour = !0;
});
M("Hmm", function(e, t, r) {
  var n = e.length - 2;
...
M("Hmmss", function(e, t, r) {
  var n = e.length - 4, s = e.length - 2;
  t[A] = b(e.substr(0, n)), t[G] = b(e.substr(n, 2)), t[ie] = b(e.substr(s));
});
function sl(e) {
  return (e + "").toLowerCase().charAt(0) === "p";
}
var al = /[ap]\.?m?\.?/i, il = Ae("Hours", !0);
function ol(e, t, r) {
...
function Pt(e) {
  var t = null, r;
  if (R[e] === void 0 && typeof module < "u" && module && module.exports && cl(e))
    try {
      t = qe._abbr, r = require, r("./locale/" + e), ge(t);
    } catch {
      R[e] = null;
    }
  return R[e];
...
function ge(e, t) {
  var r;
  return e && (U(t) ? r = ce(e) : r = Or(e, t), r ? qe = r : typeof console < "u" && console.warn && console.warn(
...
function Or(e, t) {
  if (t !== null) {
    ...
    return R[e] = new mr(tr(n, t)), Fe[e] && Fe[e].forEach(function(s) {
      Or(s.name, s.config);
    }), ge(e), R[e];
  } else
...
function hl(e, t) {
  if (t != null) {
    var r, n, s = Zn;
    R[e] != null && R[e].parentLocale != null ? R[e].set(tr(R[e]._config, t)) : (n = Pt(e), n != null && (s = n._config), t = tr(s, t), n == null && (t.abbr = e), r = new mr(t), r.parentLocale = R[e], R[e] = r), ge(e);
  } else
    R[e] != null && (R[e].parentLocale != null ? (R[e] = R[e].parentLocale, e === ge() && ge(e)) : R[e] != null && delete R[e]);
  return R[e];
}
function ce(e) {
  var t;
...
function vr(e) {
  var t, r = e._a;
  return r && w(e).overflow === -2 && (t = r[ae] < 0 || r[ae] > 11 ? ae : r[K] < 1 || r[K] > xt(r[C], r[ae]) ? K : r[A] < 0 || r[A] > 24 || r[A] === 24 && (r[G] !== 0 || r[ie] !== 0 || r[be] !== 0) ? A : r[G] < 0 || r[G] > 59 ? G : r[ie] < 0 || r[ie] > 59 ? ie : r[be] < 0 || r[be] > 999 ? be : -1, w(e)._overflowDayOfYear && (t < C || t > K) && (t = K), w(e)._overflowWeeks && t === -1 && (t = wo), w(e)._overflowWeekday && t === -1 && (t = _o), w(e).overflow = t), e;
}
var fl = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/, pl = /^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d|))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/, ml = /Z|[+-]\d\d(?::?\d\d)?/, et = [
  ...
  ["HHmm", /\d\d\d\d/],
  ["HH", /\d\d/]
], yl = /^\/?Date\((-?\d+)/i, gl = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/, wl = {
  UT: 0,
  GMT: 0,
  EDT: -4 * 60,
  EST: -5 * 60,
...
function Qn(e) {
  var t, r, n = e._i, s = fl.exec(n) || pl.exec(n), a, i, u, o, d = et.length, f = qt.length;
  if (s) {
...
function Xn(e) {
  ...
  if (t) {
    if (r = _l(
      ...
      return;
    e._a = r, e._tzm = Ol(t[8], t[9], t[10]), e._d = je.apply(null, e._a), e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), w(e).rfc2822 = !0;
  } else
    e._isValid = !1;
}
function vl(e) {
...
function Dr(e) {
  var t, r, n = [], s, a, i;
  if (!e._d) {
    for (s = Dl(e), e._w && e._a[K] == null && e._a[ae] == null && Tl(e), e._dayOfYear != null && (i = De(e._a[C], s[C]), (e._dayOfYear > Ue(i) || e._dayOfYear === 0) && (w(e)._overflowDayOfYear = !0), r = je(i, 0, e._dayOfYear), e._a[ae] = r.getUTCMonth(), e._a[K] = r.getUTCDate()), t = 0; t < 3 && e._a[t] == null; ++t)
      e._a[t] = n[t] = s[t];
    for (; t < 7; t++)
      e._a[t] = n[t] = e._a[t] == null ? t === 2 ? 1 : 0 : e._a[t];
    e._a[A] === 24 && e._a[G] === 0 && e._a[ie] === 0 && e._a[be] === 0 && (e._nextDay = !0, e._a[A] = 0), e._d = (e._useUTC ? je : No).apply(
      null,
      n
    ), a = e._useUTC ? e._d.getUTCDay() : e._d.getDay(), e._tzm != null && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), e._nextDay && (e._a[A] = 24), e._w && typeof e._w.d < "u" && e._w.d !== a && (w(e).weekdayMismatch = !0);
  }
}
function Tl(e) {
  var t, r, n, s, a, i, u, o, d;
  t = e._w, t.GG != null || t.W != null || t.E != null ? (a = 1, i = 4, r = De(
    ...
    e._a[C],
    He(E(), 1, 4).year
  ), n = De(t.W, 1), s = De(t.E, 1), (s < 1 || s > 7) && (o = !0)) : (a = e._locale._week.dow, i = e._locale._week.doy, d = He(E(), a, i), r = De(t.gg, e._a[C], d.year), n = De(t.w, d.week), t.d != null ? (s = t.d, (s < 0 || s > 6) && (o = !0)) : t.e != null ? (s = t.e + a, (t.e < 0 || t.e > 6) && (o = !0)) : s = a), n < 1 || n > le(r, a, i) ? w(e)._overflowWeeks = !0 : o != null ? w(e)._overflowWeekday = !0 : (u = $n(r, n, s, a, i), e._a[C] = u.year, e._dayOfYear = u.dayOfYear);
}
p.ISO_8601 = function() {
};
p.RFC_2822 = function() {
...
function Tr(e) {
  ...
  for (s = Yn(e._f, e._locale).match(yr) || [], f = s.length, r = 0; r < f; r++)
    a = s[r], n = (t.match(mo(a, e)) || [])[0], n && (i = t.substr(0, t.indexOf(n)), i.length > 0 && w(e).unusedInput.push(i), t = t.slice(
      t.indexOf(n) + n.length
    ), o += n.length), Ee[a] ? (n ? w(e).empty = !1 : w(e).unusedTokens.push(a), go(a, n, e)) : e._strict && !n && w(e).unusedTokens.push(a);
  w(e).charsLeftOver = u - o, t.length > 0 && w(e).unusedInput.push(t), e._a[A] <= 12 && w(e).bigHour === !0 && e._a[A] > 0 && (w(e).bigHour = void 0), w(e).parsedDateParts = e._a.slice(0), w(e).meridiem = e._meridiem, e._a[A] = Ml(
    e._locale,
    e._a[A],
    e._meridiem
  ), d = w(e).era, d !== null && (e._a[C] = e._locale.erasConvertYear(d, e._a[C])), Dr(e), vr(e);
}
function Ml(e, t, r) {
  var n;
...
function El(e) {
  ...
  for (s = 0; s < o; s++)
    a = 0, i = !1, t = pr({}, e), e._useUTC != null && (t._useUTC = e._useUTC), t._f = e._f[s], Tr(t), fr(t) && (i = !0), a += w(t).charsLeftOver, a += w(t).unusedTokens.length * 10, w(t).score = a, u ? a < n && (n = a, r = t) : (n == null || a < n || i) && (n = a, r = t, i && (u = !0));
  me(e, r || t);
}
function xl(e) {
  if (!e._d) {
...
function Pl(e) {
  var t = new Je(vr(es(e)));
  return t._nextDay && (t.add(1, "d"), t._nextDay = void 0), t;
}
function es(e) {
  var t = e._i, r = e._f;
  return e._locale = e._locale || ce(e._l), t === null || r === void 0 && t === "" ? St({ nullInput: !0 }) : (typeof t == "string" && (e._i = t = e._locale.preparse(t)), z(t) ? new Je(vr(t)) : (ze(t) ? e._d = t : $(r) ? El(e) : r ? Tr(e) : Rl(e), fr(e) || (e._d = null), e));
}
function Rl(e) {
  var t = e._i;
  U(t) ? e._d = new Date(p.now()) : ze(t) ? e._d = new Date(t.valueOf()) : typeof t == "string" ? vl(e) : $(t) ? (e._a = Rn(t.slice(0), function(r) {
    return parseInt(r, 10);
  }), Dr(e)) : ke(t) ? xl(e) : ue(t) ? e._d = new Date(t) : p.createFromInputFallback(e);
}
function ts(e, t, r, n, s) {
  var a = {};
  return (t === !0 || t === !1) && (n = t, t = void 0), (r === !0 || r === !1) && (n = r, r = void 0), (ke(e) && dr(e) || $(e) && e.length === 0) && (e = void 0), a._isAMomentObject = !0, a._useUTC = a._isUTC = s, a._l = r, a._i = e, a._f = t, a._strict = n, Pl(a);
}
function E(e, t, r, n) {
  return ts(e, t, r, n, !1);
}
...
function Rt(e) {
  ...
  this._isValid = Ll(t), this._milliseconds = +f + d * 1e3 + // 1000
  o * 6e4 + // 1000 * 60
  u * 1e3 * 60 * 60, this._days = +i + a * 7, this._months = +s + n * 3 + r * 12, this._data = {}, this._locale = ce(), this._bubble();
}
function ot(e) {
...
function ns(e, t) {
  g(e, 0, 0, function() {
    ...
    return r < 0 && (r = -r, n = "-"), n + Q(~~(r / 60), 2) + t + Q(~~r % 60, 2);
  });
}
ns("Z", ":");
ns("ZZ", "");
...
function Mr(e, t) {
  ...
  return r === null ? null : (n = r[r.length - 1] || [], s = (n + "").match(Wl) || ["-", 0, 0], a = +(s[1] * 60) + b(s[2]), a === 0 ? 0 : s[0] === "+" ? a : -a);
}
function Er(e, t) {
  var r, n;
...
function Jl() {
  ...
  var e = {}, t;
  return pr(e, this), e = es(e), e._a ? (t = e._isUTC ? ee(e._a) : E(e._a), this._isDSTShifted = this.isValid() && Bl(e._a, t.toArray()) > 0) : this._isDSTShifted = !1, this._isDSTShifted;
}
function Kl() {
...
function J(e, t) {
  ...
  return ot(e) ? r = {
    ...
    d: e._days,
    M: e._months
  } : ue(e) || !isNaN(+e) ? (r = {}, t ? r[t] = +e : r.milliseconds = +e) : (n = Ql.exec(e)) ? (s = n[1] === "-" ? -1 : 1, r = {
    y: 0,
    d: b(n[K]) * s,
    h: b(n[A]) * s,
    m: b(n[G]) * s,
    ...
    m: _e(n[7], s),
    s: _e(n[8], s)
  }) : r == null ? r = {} : typeof r == "object" && ("from" in r || "to" in r) && (i = eu(
    E(r.from),
    E(r.to)
  ), r = {}, r.ms = i.milliseconds, r.M = i.months), a = new Rt(r), ot(e) && v(e, "_locale") && (a._locale = e._locale), ot(e) && v(e, "_isValid") && (a._isValid = e._isValid), a;
}
J.fn = Rt.prototype;
J.invalid = Ul;
function _e(e, t) {
...
function as(e, t) {
  return function(r, n) {
    ...
    ), a = r, r = n, n = a), s = J(r, n), is(this, s, e), this;
  };
}
function is(e, t, r, n) {
...
var tu = as(1, "add"), ru = as(-1, "subtract");
function os(e) {
  return typeof e == "string" || e instanceof String;
}
function nu(e) {
  return z(e) || ze(e) || os(e) || ue(e) || au(e) || su(e) || e === null || e === void 0;
}
function su(e) {
  var t = ke(e) && !dr(e), r = !1, n = [
    "years",
    "year",
    "y",
    "months",
...
function lu(e, t) {
  arguments.length === 1 && (arguments[0] ? nu(arguments[0]) ? (e = arguments[0], t = void 0) : iu(arguments[0]) && (t = arguments[0], e = void 0) : (e = void 0, t = void 0));
  var r = e || E(), n = Er(r, this).startOf("day"), s = p.calendarFormat(this, n) || "sameElse", a = t && (te(t[s]) ? t[s].call(this, r) : t[s]);
  return this.format(
...
function wu(e) {
  ...
  ) : te(Date.prototype.toISOString) ? t ? this.toDate().toISOString() : new Date(this.valueOf() + this.utcOffset() * 60 * 1e3).toISOString().replace("Z", it(r, "Z")) : it(
    r,
...
function ku(e, t) {
  return this.isValid() && (z(e) && e.isValid() || E(e).isValid()) ? J({ to: this, from: e }).locale(this.locale()).humanize(!t) : this.localeData().invalidDate();
}
function Su(e) {
  return this.from(E(), e);
}
function Ou(e, t) {
  return this.isValid() && (z(e) && e.isValid() || E(e).isValid()) ? J({ from: this, to: e }).locale(this.locale()).humanize(!t) : this.localeData().invalidDate();
}
function vu(e) {
  return this.to(E(), e);
}
...
var ft = 1e3, xe = 60 * ft, pt = 60 * xe, hs = (365 * 400 + 97) * 24 * pt;
function Pe(e, t) {
  return (e % t + t) % t;
}
function ds(e, t, r) {
...
function Tu(e) {
  ...
  switch (r = this._isUTC ? fs : ds, e) {
    ...
    case "date":
      ...
      break;
    case "hour":
      t = this._d.valueOf(), t += pt - Pe(
        t + (this._isUTC ? 0 : this.utcOffset() * xe),
        pt
      ) - 1;
      break;
    case "minute":
      t = this._d.valueOf(), t += xe - Pe(t, xe) - 1;
      break;
    case "second":
...
function Lu(e, t) {
  var r, n, s, a = this._eras || ce("en")._eras;
...
function qu(e) {
  return v(this, "_erasNameRegex") || Pr.call(this), e ? this._erasNameRegex : this._erasRegex;
}
function Vu(e) {
  return v(this, "_erasAbbrRegex") || Pr.call(this), e ? this._erasAbbrRegex : this._erasRegex;
}
function Gu(e) {
  return v(this, "_erasNarrowRegex") || Pr.call(this), e ? this._erasNarrowRegex : this._erasRegex;
}
function xr(e, t) {
...
function Pr() {
  ...
  for (s = 0, a = i.length; s < a; ++s)
    t.push(B(i[s].name)), e.push(B(i[s].abbr)), r.push(B(i[s].narrow)), n.push(B(i[s].name)), n.push(B(i[s].abbr)), n.push(B(i[s].narrow));
...
function ps(e, t, r, n, s) {
  var a;
  return e == null ? He(this, n, s).year : (a = le(e, n, s), t > a && (t = a), rc.call(this, e, t, r, n, s));
}
...
h.weekYear = Ku;
h.isoWeekYear = Zu;
h.quarter = h.quarters = nc;
h.month = qn;
h.daysInMonth = Eo;
h.week = h.weeks = Lo;
h.isoWeek = h.isoWeeks = Io;
h.weeksInYear = ec;
h.weeksInWeekYear = tc;
h.isoWeeksInYear = Qu;
h.isoWeeksInISOWeekYear = Xu;
h.date = ms;
h.day = h.days = Zo;
h.weekday = Qo;
h.isoWeekday = Xo;
h.dayOfYear = sc;
h.hour = h.hours = il;
h.minute = h.minutes = ac;
h.second = h.seconds = ic;
h.millisecond = h.milliseconds = ys;
h.utcOffset = jl;
h.utc = ql;
h.local = Vl;
h.parseZone = Gl;
h.hasAlignedHourOffset = $l;
h.isDST = zl;
h.isLocal = Kl;
h.isUtcOffset = Zl;
h.isUtc = ss;
...
D.eras = Lu;
D.erasParse = Iu;
D.erasConvertYear = Uu;
D.erasAbbrRegex = Vu;
D.erasNameRegex = qu;
D.erasNarrowRegex = Gu;
D.months = vo;
D.monthsShort = Do;
D.monthsParse = Mo;
D.monthsRegex = Po;
...
D.weekdaysParse = Ko;
D.weekdaysRegex = el;
D.weekdaysShortRegex = tl;
D.weekdaysMinRegex = rl;
D.isPM = sl;
D.meridiem = ol;
function mt(e, t, r, n) {
  var s = ce(), a = ee().set(n, t);
  return s[r](a, e);
}
function ws(e, t, r) {
...
function Rr(e, t, r, n) {
  ...
  var s = ce(), a = e ? s._week.dow : 0, i, u = [];
  if (r != null)
...
function pc(e, t, r) {
  return Rr(e, t, r, "weekdays");
}
function mc(e, t, r) {
  return Rr(e, t, r, "weekdaysShort");
}
function yc(e, t, r) {
  return Rr(e, t, r, "weekdaysMin");
}
ge("en", {
  eras: [
    {
...
var Oc = he("ms"), vc = he("s"), Dc = he("m"), Tc = he("h"), Mc = he("d"), Ec = he("w"), xc = he("M"), Pc = he("Q"), Rc = he("y");
function Nc() {
  return J(this);
}
function Ac(e) {
...
var Yc = Oe("milliseconds"), Cc = Oe("seconds"), Fc = Oe("minutes"), Lc = Oe("hours"), Ic = Oe("days"), Uc = Oe("months"), Bc = Oe("years");
function Wc() {
...
function Hc(e, t, r, n) {
  var s = J(e).abs(), a = se(s.as("s")), i = se(s.as("m")), u = se(s.as("h")), o = se(s.as("d")), d = se(s.as("M")), f = se(s.as("w")), _ = se(s.as("y")), k = a <= r.ss && ["s", a] || a < r.s && ["ss", a] || i <= 1 && ["m"] || i < r.m && ["mm", i] || u <= 1 && ["h"] || u < r.h && ["hh", u] || o <= 1 && ["d"] || o < r.d && ["dd", o];
  return r.w != null && (k = k || f <= 1 && ["w"] || f < r.w && ["ww", f]), k = k || d <= 1 && ["M"] || d < r.M && ["MM", d] || _ <= 1 && ["y"] || ["yy", _], k[2] = t, k[3] = +e > 0, k[4] = n, jc.apply(null, k);
}
function qc(e) {
...
function Gc(e, t) {
  ...
  var r = !1, n = Te, s, a;
  return typeof e == "object" && (t = e, e = !1), typeof e == "boolean" && (r = e), typeof t == "object" && (n = Object.assign({}, Te, t), t.s != null && t.ss == null && (n.ss = t.s - 1)), s = this.localeData(), a = Hc(this, !r, n, s), r && (a = s.pastFuture(+this, a)), s.postformat(a);
}
var Vt = Math.abs;
function ve(e) {
  return (e > 0) - (e < 0) || +e;
...
function At() {
  if (!this.isValid())
    return this.localeData().invalidDate();
  var e = Vt(this._milliseconds) / 1e3, t = Vt(this._days), r = Vt(this._months), n, s, a, i, u = this.asSeconds(), o, d, f, _;
  return u ? (n = j(e / 60), s = j(n / 60), e %= 60, n %= 60, a = j(r / 12), r %= 12, i = e ? e.toFixed(3).replace(/\.?0+$/, "") : "", o = u < 0 ? "-" : "", d = ve(this._months) !== ve(u) ? "-" : "", f = ve(this._days) !== ve(u) ? "-" : "", _ = ve(this._milliseconds) !== ve(u) ? "-" : "", o + "P" + (a ? d + a + "Y" : "") + (r ? d + r + "M" : "") + (t ? f + t + "D" : "") + (s || n || e ? "T" : "") + (s ? _ + s + "H" : "") + (n ? _ + n + "M" : "") + (e ? _ + i + "S" : "")) : "P0D";
}
var S = Rt.prototype;
S.isValid = Il;
S.abs = gc;
...
p.weekdaysShort = mc;
p.normalizeUnits = V;
p.relativeTimeRounding = qc;
p.relativeTimeThreshold = Vc;
p.calendarFormat = ou;
p.prototype = h;
p.HTML5_FMT = {
...
const I = Vi, Zc = new Hi(`${self.name}-worker:wakatime`), we = new Wi(
  {
    baseURL: qi(self.location.pathname, `plugins/${self.name}/workers/wakatime.js`)
  },
  "fetch"
), ks = /* @__PURE__ */ new Map(), Be = new Ve(we, Se.OFFLINE_CACHE_PATH), tt = [], Me = {
  heartbeat: 0,
  // 心跳定时器
  cacheCheck: 0
  // 缓存检查定时器
...
async function Qc(e = Se.OFFLINE_CACHE_PATH) {
  return we.putFile({
    isDir: !0,
    path: e
  });
}
function Xc(e = I.wakatime.interval) {
  clearInterval(Me.heartbeat), Me.heartbeat = setInterval(Ss, e * 1e3), clearInterval(Me.cacheCheck), Me.cacheCheck = setInterval(rh, Se.CACHE_CHECK_INTERVAL);
}
function eh() {
  T.includeID = ih(), T.excludeID = lh(), T.include = oh(), T.exclude = uh();
}
async function th() {
...
async function Ss() {
  ...
  if (T.actions.push(...n), T.actions.length > 0) {
    ...
    T.actions.length = 0;
    const a = [];
    for (let i = 0; i < s.length; i += Se.WAKATIME_HEARTBEATS_BULK)
      a.push(Os(s.slice(i, i + Se.WAKATIME_HEARTBEATS_BULK)));
    if (I.wakatime.heartbeats)
      for (const i of a)
        await vs(
          i,
          (u) => {
            I.wakatime.offline && Be.push(u.payload);
          }
        );
    else
      I.wakatime.offline && Be.push(...a.map((i) => i.payload));
    await Be.save();
  }
}
async function rh() {
  const e = await Be.getAllCacheFileName();
  if (tt.length = 0, tt.push(...e.map((t) => new Ve(
    we,
    Se.OFFLINE_CACHE_PATH,
    t
  ))), tt.length > 0)
    for (const t of tt)
      if (I.wakatime.heartbeats) {
        ...
        for (let n = 0; n < t.length; ++n) {
          ...
          if (await vs(
            ...
            return;
          await Kc(Se.CACHE_COMMIT_INTERVAL);
        }
        if (r.length > 0) {
...
async function sh(e) {
  return Promise.all(e.flatMap((t) => t.events.map((r) => nh(
    t,
    r.time,
    r.is_write
  ))));
...
function ah(e = /* @__PURE__ */ new Date()) {
...
async function ch() {
  await Qc(), await Be.load(), await th();
}
async function hh() {
...
async function mh(e) {
  try {
    const t = Ds();
    let r = T.blocks.get(e), n = T.roots.get(r);
    if (!n) {
